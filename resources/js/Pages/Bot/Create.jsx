...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        ...
        post("/new-bot", {
            data,
            onSuccess: () => {
                toast.success("Bot ajouté avec succès !");
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Ajouter un Bot de Trading</h2>}
        >
            <Head title="Ajouter un TradingBot" />
            <div className="py-12">
                        ...
                        <div className="p-6 bg-white border-b border-gray-200">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <PrimaryButton type="submit">Ajouter le Bot</PrimaryButton>
                                </div>
                            </form>
                        </div>
                    </div>
